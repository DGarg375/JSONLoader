...
class DirectionalLight extends Light {
    ...
    update( ) {
        // throw '"AmbientLight.update" not implemented'
        // TODO: Pass the light properties to the shader
        let quart = mat4.getRotation(mat4.create(), this.model_matrix)
        let direction = vec3.transformQuat(vec3.create(), [0, -1, 0], quart);
        this.target_shader.use();
...
class PointLight extends Light {
    ...
    update( ) {
        // throw '"AmbientLight.update" not implemented'
        // TODO: Pass the light properties to the shader
        let something = mat4.getTranslation(vec3.create(), this.model_matrix);
        this.target_shader.use();
        this.target_shader.setUniform3f(`u_lights_point[${this.id}].position`, something);
